...
source_paths: ["apt-principles-agents/prompts/modernization/bridge-architecture-review.md"]
---
...
Use this prompt to inventory legacy behavior before designing a facade, adapter, bridge, parity plan, dual run, deprecation path, and rollback.

## Prompt

You are performing an APT bridge architecture review.
...
Expected evidence: legacy inventory, field/error/auth mappings, parity matrix, contract and replay tests, observability, dual-run metrics, communications, and rollback plan.
