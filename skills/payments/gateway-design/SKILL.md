...
domain: "payments"
source_paths: ["apt-principles-agents/skills/payments/gateway-design/SKILL.md"]
---
...
Produce a reviewable gateway design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Gateway Design** as an explicit decision with defined scope, evidence, owner, and validation.
