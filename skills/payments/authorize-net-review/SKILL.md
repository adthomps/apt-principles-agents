...
domain: "payments"
source_paths: ["apt-principles-agents/skills/payments/authorize-net-review/SKILL.md"]
---
...
Produce a reviewable authorize net review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Authorize Net Review** as an explicit decision with defined scope, evidence, owner, and validation.
