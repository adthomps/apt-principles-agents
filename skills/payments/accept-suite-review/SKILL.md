...
Produce a reviewable accept suite review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Accept Suite Review** as an explicit decision with defined scope, evidence, owner, and validation.
