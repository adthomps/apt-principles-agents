...
domain: "payments"
source_paths: ["apt-principles-agents/skills/payments/fraud-rule-review/SKILL.md"]
---
...
Produce a reviewable fraud rule review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Fraud Rule Review** as an explicit decision with defined scope, evidence, owner, and validation.
