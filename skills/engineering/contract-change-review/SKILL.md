...
domain: "engineering"
source_paths: ["apt-principles-agents/skills/engineering/contract-change-review/SKILL.md"]
---
...
Produce a reviewable contract change review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Contract Change Review** as an explicit decision with defined scope, evidence, owner, and validation.
