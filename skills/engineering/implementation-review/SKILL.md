...
domain: "engineering"
source_paths: ["apt-principles-agents/skills/engineering/implementation-review/SKILL.md"]
---
...
Produce a reviewable implementation review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Implementation Review** as an explicit decision with defined scope, evidence, owner, and validation.
