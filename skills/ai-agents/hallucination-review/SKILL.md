...
domain: "ai-agents"
source_paths: ["apt-principles-agents/skills/ai-agents/hallucination-review/SKILL.md"]
---
...
Produce a reviewable hallucination review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Hallucination Review** as an explicit decision with defined scope, evidence, owner, and validation.
