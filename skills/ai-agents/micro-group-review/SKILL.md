...
domain: "ai-agents"
source_paths: ["apt-principles-agents/skills/ai-agents/micro-group-review/SKILL.md"]
---
...
Produce a reviewable micro group review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Micro Group Review** as an explicit decision with defined scope, evidence, owner, and validation.
