...
domain: "ai-agents"
source_paths: ["apt-principles-agents/skills/ai-agents/red-team-review/SKILL.md"]
---
...
Produce a reviewable red team review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Red Team Review** as an explicit decision with defined scope, evidence, owner, and validation.
