...
domain: "ai-agents"
source_paths: ["apt-principles-agents/skills/ai-agents/troubleshooting-swarm/SKILL.md"]
---
...
Produce a reviewable troubleshooting swarm outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Troubleshooting Swarm** as an explicit decision with defined scope, evidence, owner, and validation.
- Assign distinct perspectives, share evidence, avoid duplicated work, reconcile disagreements, and retain approval ownership.
