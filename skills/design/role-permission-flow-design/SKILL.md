---
name: role-permission-flow-design
...
domain: "design"
source_paths: ["apt-principles-agents/skills/design/role-permission-flow-design/SKILL.md"]
---

# Role Permission Flow Design

## Purpose

Produce a reviewable role permission flow design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Role Permission Flow Design** as an explicit decision with defined scope, evidence, owner, and validation.
