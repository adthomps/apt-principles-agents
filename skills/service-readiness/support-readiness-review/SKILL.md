...
source_paths: ["apt-principles-agents/skills/service-readiness/support-readiness-review/SKILL.md"]
---
...
Produce a reviewable support readiness review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Support Readiness Review** as an explicit decision with defined scope, evidence, owner, and validation.
