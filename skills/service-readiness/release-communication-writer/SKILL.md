...
Produce a reviewable release communication writer outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Release Communication Writer** as an explicit decision with defined scope, evidence, owner, and validation.
