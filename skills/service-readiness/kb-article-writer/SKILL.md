...
source_paths: ["apt-principles-agents/skills/service-readiness/kb-article-writer/SKILL.md"]
---
...
Produce a reviewable kb article writer outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Kb Article Writer** as an explicit decision with defined scope, evidence, owner, and validation.
