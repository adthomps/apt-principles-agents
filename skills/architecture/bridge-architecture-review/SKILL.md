---
name: bridge-architecture-review
...
domain: "architecture"
source_paths: ["apt-principles-agents/skills/architecture/bridge-architecture-review/SKILL.md"]
---
...
Produce a reviewable bridge architecture review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Bridge Architecture Review** as an explicit decision with defined scope, evidence, owner, and validation.
- Specify both contracts, transformations, parity gaps, observability, rollback, and bridge retirement criteria.
