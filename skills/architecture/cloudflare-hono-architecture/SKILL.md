---
name: cloudflare-hono-architecture
...
domain: "architecture"
source_paths: ["apt-principles-agents/skills/architecture/cloudflare-hono-architecture/SKILL.md"]
---
...
Produce a reviewable cloudflare hono architecture outcome that is grounded in repository evidence and explicit about uncertainty.
