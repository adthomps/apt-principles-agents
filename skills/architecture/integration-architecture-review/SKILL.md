...
domain: "architecture"
source_paths: ["apt-principles-agents/skills/architecture/integration-architecture-review/SKILL.md"]
---
...
Produce a reviewable integration architecture review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Integration Architecture Review** as an explicit decision with defined scope, evidence, owner, and validation.
