...
domain: "architecture"
source_paths: ["apt-principles-agents/skills/architecture/api-architecture-review/SKILL.md"]
---
...
Produce a reviewable api architecture review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Api Architecture Review** as an explicit decision with defined scope, evidence, owner, and validation.
