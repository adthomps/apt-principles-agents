...
source_paths: ["apt-principles-agents/skills/documentation/business-guide-writer/SKILL.md"]
---

# Business Guide Writer

## Purpose

Produce a reviewable business guide writer outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Business Guide Writer** as an explicit decision with defined scope, evidence, owner, and validation.
