...
source_paths: ["apt-principles-agents/skills/documentation/api-guide-writer/SKILL.md"]
---
...
Produce a reviewable api guide writer outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Api Guide Writer** as an explicit decision with defined scope, evidence, owner, and validation.
