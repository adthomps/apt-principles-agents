...
source_paths: ["apt-principles-agents/skills/documentation/product-hub-builder/SKILL.md"]
---
...
Produce a reviewable product hub builder outcome that is grounded in repository evidence and explicit about uncertainty.
