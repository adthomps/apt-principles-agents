...
source_paths: ["apt-principles-agents/skills/documentation/diagram-generator/SKILL.md"]
---
...
Produce a reviewable diagram generator outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Diagram Generator** as an explicit decision with defined scope, evidence, owner, and validation.
