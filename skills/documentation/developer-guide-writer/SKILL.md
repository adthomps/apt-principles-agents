...
source_paths: ["apt-principles-agents/skills/documentation/developer-guide-writer/SKILL.md"]
---
...
Produce a reviewable developer guide writer outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Developer Guide Writer** as an explicit decision with defined scope, evidence, owner, and validation.
