...
source_paths: ["apt-principles-agents/skills/documentation/operations-guide-writer/SKILL.md"]
---
...
Produce a reviewable operations guide writer outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Operations Guide Writer** as an explicit decision with defined scope, evidence, owner, and validation.
