---
name: marketplace-payments-review
...
domain: "ecommerce"
source_paths: ["apt-principles-agents/skills/ecommerce/marketplace-payments-review/SKILL.md"]
---

# Marketplace Payments Review

## Purpose

Produce a reviewable marketplace payments review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Marketplace Payments Review** as an explicit decision with defined scope, evidence, owner, and validation.
