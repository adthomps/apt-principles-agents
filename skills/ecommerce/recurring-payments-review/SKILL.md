---
name: recurring-payments-review
...
domain: "ecommerce"
source_paths: ["apt-principles-agents/skills/ecommerce/recurring-payments-review/SKILL.md"]
---

# Recurring Payments Review

## Purpose

Produce a reviewable recurring payments review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Recurring Payments Review** as an explicit decision with defined scope, evidence, owner, and validation.
