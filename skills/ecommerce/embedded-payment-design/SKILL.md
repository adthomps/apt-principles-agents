...
domain: "ecommerce"
source_paths: ["apt-principles-agents/skills/ecommerce/embedded-payment-design/SKILL.md"]
---
...
Produce a reviewable embedded payment design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Embedded Payment Design** as an explicit decision with defined scope, evidence, owner, and validation.
