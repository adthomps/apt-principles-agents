...
domain: "ecommerce"
source_paths: ["apt-principles-agents/skills/ecommerce/invoice-payments-review/SKILL.md"]
---

# Invoice Payments Review

## Purpose

Produce a reviewable invoice payments review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Invoice Payments Review** as an explicit decision with defined scope, evidence, owner, and validation.
