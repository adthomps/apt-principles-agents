...
domain: "ecommerce"
source_paths: ["apt-principles-agents/skills/ecommerce/hosted-payment-design/SKILL.md"]
---

# Hosted Payment Design

## Purpose

Produce a reviewable hosted payment design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Hosted Payment Design** as an explicit decision with defined scope, evidence, owner, and validation.
