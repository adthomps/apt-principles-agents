...
source_paths: ["apt-principles-agents/skills/stablecoin-crypto/wallet-checkout-review/SKILL.md"]
---

# Wallet Checkout Review

## Purpose

Produce a reviewable wallet checkout review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Wallet Checkout Review** as an explicit decision with defined scope, evidence, owner, and validation.
