---
name: on-chain-off-chain-payment-design
...
source_paths: ["apt-principles-agents/skills/stablecoin-crypto/on-chain-off-chain-payment-design/SKILL.md"]
---

# On Chain Off Chain Payment Design

## Purpose

Produce a reviewable on chain off chain payment design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **On Chain Off Chain Payment Design** as an explicit decision with defined scope, evidence, owner, and validation.
