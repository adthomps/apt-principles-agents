...
source_paths: ["apt-principles-agents/skills/security-risk/privacy-review/SKILL.md"]
---
...
Produce a reviewable privacy review outcome that is grounded in repository evidence and explicit about uncertainty.
