...
source_paths: ["apt-principles-agents/skills/security-risk/permission-review/SKILL.md"]
---
...
Produce a reviewable permission review outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Permission Review** as an explicit decision with defined scope, evidence, owner, and validation.
