...
domain: "thinking"
source_paths: ["apt-principles-agents/skills/thinking/decision-rationalization/SKILL.md"]
---
...
Produce a reviewable decision rationalization outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Decision Rationalization** as an explicit decision with defined scope, evidence, owner, and validation.
- Record context, options, recommendation, rationale, consequences, owner, and revisit trigger.
