...
domain: "api"
source_paths: ["apt-principles-agents/skills/api/api-error-design/SKILL.md"]
---
...
Produce a reviewable api error design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Api Error Design** as an explicit decision with defined scope, evidence, owner, and validation.
- Specify stable codes, safe messages, correlation identifiers, retryability, and support interpretation.
