...
domain: "api"
source_paths: ["apt-principles-agents/skills/api/json-first-design/SKILL.md"]
---
...
Produce a reviewable json first design outcome that is grounded in repository evidence and explicit about uncertainty.
