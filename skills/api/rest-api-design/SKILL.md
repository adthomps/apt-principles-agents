...
domain: "api"
source_paths: ["apt-principles-agents/skills/api/rest-api-design/SKILL.md"]
---
...
Produce a reviewable rest api design outcome that is grounded in repository evidence and explicit about uncertainty.
