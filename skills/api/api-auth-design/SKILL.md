...
domain: "api"
source_paths: ["apt-principles-agents/skills/api/api-auth-design/SKILL.md"]
---
...
Produce a reviewable api auth design outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Api Auth Design** as an explicit decision with defined scope, evidence, owner, and validation.
