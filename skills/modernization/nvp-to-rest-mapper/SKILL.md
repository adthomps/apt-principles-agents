...
source_paths: ["apt-principles-agents/skills/modernization/nvp-to-rest-mapper/SKILL.md"]
---
...
Produce a reviewable nvp to rest mapper outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Nvp To Rest Mapper** as an explicit decision with defined scope, evidence, owner, and validation.
