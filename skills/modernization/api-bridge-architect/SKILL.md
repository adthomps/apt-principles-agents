...
source_paths: ["apt-principles-agents/skills/modernization/api-bridge-architect/SKILL.md"]
---

# API Bridge Architect

## Purpose

Produce a reviewable api bridge architect outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Api Bridge Architect** as an explicit decision with defined scope, evidence, owner, and validation.
