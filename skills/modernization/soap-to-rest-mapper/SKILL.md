...
source_paths: ["apt-principles-agents/skills/modernization/soap-to-rest-mapper/SKILL.md"]
---
...
Produce a reviewable soap to rest mapper outcome that is grounded in repository evidence and explicit about uncertainty.
...
- Treat **Soap To Rest Mapper** as an explicit decision with defined scope, evidence, owner, and validation.
