...
domain: "ecommerce"
source_paths: ["apt-principles-agents/principles/ecommerce/customer-payment-experience.md"]
---
...
- Treat **Customer Payment Experience** as an explicit decision with defined scope, evidence, owner, and validation.
