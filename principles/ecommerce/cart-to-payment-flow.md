...
domain: "ecommerce"
source_paths: ["apt-principles-agents/principles/ecommerce/cart-to-payment-flow.md"]
---
...
- Treat **Cart To Payment Flow** as an explicit decision with defined scope, evidence, owner, and validation.
