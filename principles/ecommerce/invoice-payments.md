...
domain: "ecommerce"
source_paths: ["apt-principles-agents/principles/ecommerce/invoice-payments.md"]
---
...
- Treat **Invoice Payments** as an explicit decision with defined scope, evidence, owner, and validation.
