...
domain: "ecommerce"
source_paths: ["apt-principles-agents/principles/ecommerce/marketplace-payments.md"]
---
...
- Treat **Marketplace Payments** as an explicit decision with defined scope, evidence, owner, and validation.
