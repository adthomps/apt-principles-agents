...
domain: "ecommerce"
source_paths: ["apt-principles-agents/principles/ecommerce/payment-links.md"]
---
...
- Treat **Payment Links** as an explicit decision with defined scope, evidence, owner, and validation.
