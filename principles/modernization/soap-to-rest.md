...
source_paths: ["apt-principles-agents/principles/modernization/soap-to-rest.md"]
---
...
- Treat **Soap To Rest** as an explicit decision with defined scope, evidence, owner, and validation.
