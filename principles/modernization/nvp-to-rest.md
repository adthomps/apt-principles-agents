...
source_paths: ["apt-principles-agents/principles/modernization/nvp-to-rest.md"]
---
...
- Treat **Nvp To Rest** as an explicit decision with defined scope, evidence, owner, and validation.
