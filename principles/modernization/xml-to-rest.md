...
source_paths: ["apt-principles-agents/principles/modernization/xml-to-rest.md"]
---
...
- Treat **Xml To Rest** as an explicit decision with defined scope, evidence, owner, and validation.
