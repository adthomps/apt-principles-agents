...
source_paths: ["apt-principles-agents/principles/modernization/dual-run-migration.md"]
---
...
- Treat **Dual Run Migration** as an explicit decision with defined scope, evidence, owner, and validation.
