...
source_paths: ["apt-principles-agents/principles/modernization/parity-matrix.md"]
---
...
- Treat **Parity Matrix** as an explicit decision with defined scope, evidence, owner, and validation.
