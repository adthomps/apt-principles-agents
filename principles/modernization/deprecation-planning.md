...
source_paths: ["apt-principles-agents/principles/modernization/deprecation-planning.md"]
---
...
- Treat **Deprecation Planning** as an explicit decision with defined scope, evidence, owner, and validation.
