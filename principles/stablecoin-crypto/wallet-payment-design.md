...
source_paths: ["apt-principles-agents/principles/stablecoin-crypto/wallet-payment-design.md"]
---
...
- Treat **Wallet Payment Design** as an explicit decision with defined scope, evidence, owner, and validation.
