...
source_paths: ["apt-principles-agents/principles/stablecoin-crypto/settlement-and-reconciliation.md"]
---
...
- Treat **Settlement And Reconciliation** as an explicit decision with defined scope, evidence, owner, and validation.
