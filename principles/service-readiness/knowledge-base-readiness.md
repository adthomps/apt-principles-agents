...
source_paths: ["apt-principles-agents/principles/service-readiness/knowledge-base-readiness.md"]
---
...
- Treat **Knowledge Base Readiness** as an explicit decision with defined scope, evidence, owner, and validation.
