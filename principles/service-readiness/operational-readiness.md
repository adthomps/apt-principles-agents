...
source_paths: ["apt-principles-agents/principles/service-readiness/operational-readiness.md"]
---
...
- Treat **Operational Readiness** as an explicit decision with defined scope, evidence, owner, and validation.
