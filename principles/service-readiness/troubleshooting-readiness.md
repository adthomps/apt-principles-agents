...
source_paths: ["apt-principles-agents/principles/service-readiness/troubleshooting-readiness.md"]
---
...
- Treat **Troubleshooting Readiness** as an explicit decision with defined scope, evidence, owner, and validation.
