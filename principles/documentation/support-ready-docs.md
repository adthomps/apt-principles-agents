...
source_paths: ["apt-principles-agents/principles/documentation/support-ready-docs.md"]
---
...
- Treat **Support Ready Docs** as an explicit decision with defined scope, evidence, owner, and validation.
