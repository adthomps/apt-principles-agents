...
source_paths: ["apt-principles-agents/principles/documentation/diagrams-and-demos.md"]
---
...
- Treat **Diagrams And Demos** as an explicit decision with defined scope, evidence, owner, and validation.
