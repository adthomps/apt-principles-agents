...
domain: "architecture"
source_paths: ["apt-principles-agents/principles/architecture/api-architecture.md"]
---
...
- Treat **Api Architecture** as an explicit decision with defined scope, evidence, owner, and validation.
