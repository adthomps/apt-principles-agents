...
domain: "architecture"
source_paths: ["apt-principles-agents/principles/architecture/payment-architecture.md"]
---
...
- Treat **Payment Architecture** as an explicit decision with defined scope, evidence, owner, and validation.
