...
domain: "architecture"
source_paths: ["apt-principles-agents/principles/architecture/event-driven-architecture.md"]
---
...
- Treat **Event Driven Architecture** as an explicit decision with defined scope, evidence, owner, and validation.
