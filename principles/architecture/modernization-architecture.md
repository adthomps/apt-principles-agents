...
domain: "architecture"
source_paths: ["apt-principles-agents/principles/architecture/modernization-architecture.md"]
---
...
- Treat **Modernization Architecture** as an explicit decision with defined scope, evidence, owner, and validation.
