...
domain: "architecture"
source_paths: ["apt-principles-agents/principles/architecture/integration-architecture.md"]
---
...
- Treat **Integration Architecture** as an explicit decision with defined scope, evidence, owner, and validation.
