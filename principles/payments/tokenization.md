...
domain: "payments"
source_paths: ["apt-principles-agents/principles/payments/tokenization.md"]
---
...
- Treat **Tokenization** as an explicit decision with defined scope, evidence, owner, and validation.
