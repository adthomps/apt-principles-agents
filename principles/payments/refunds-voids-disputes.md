...
domain: "payments"
source_paths: ["apt-principles-agents/principles/payments/refunds-voids-disputes.md"]
---
...
- Treat **Refunds Voids Disputes** as an explicit decision with defined scope, evidence, owner, and validation.
