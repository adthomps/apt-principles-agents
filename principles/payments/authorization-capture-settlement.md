...
domain: "payments"
source_paths: ["apt-principles-agents/principles/payments/authorization-capture-settlement.md"]
---
...
- Treat **Authorization Capture Settlement** as an explicit decision with defined scope, evidence, owner, and validation.
