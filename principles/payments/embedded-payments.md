...
domain: "payments"
source_paths: ["apt-principles-agents/principles/payments/embedded-payments.md"]
---
...
- Treat **Embedded Payments** as an explicit decision with defined scope, evidence, owner, and validation.
