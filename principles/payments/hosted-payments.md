...
domain: "payments"
source_paths: ["apt-principles-agents/principles/payments/hosted-payments.md"]
---
...
- Treat **Hosted Payments** as an explicit decision with defined scope, evidence, owner, and validation.
