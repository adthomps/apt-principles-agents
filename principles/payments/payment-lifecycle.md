...
domain: "payments"
source_paths: ["apt-principles-agents/principles/payments/payment-lifecycle.md"]
---
...
- Treat **Payment Lifecycle** as an explicit decision with defined scope, evidence, owner, and validation.
