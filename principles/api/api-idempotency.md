...
domain: "api"
source_paths: ["apt-principles-agents/principles/api/api-idempotency.md"]
---
...
- Treat **Api Idempotency** as an explicit decision with defined scope, evidence, owner, and validation.
