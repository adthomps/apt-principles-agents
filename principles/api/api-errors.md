...
domain: "api"
source_paths: ["apt-principles-agents/principles/api/api-errors.md"]
---
...
- Treat **Api Errors** as an explicit decision with defined scope, evidence, owner, and validation.
