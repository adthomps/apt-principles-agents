...
domain: "design"
source_paths: ["apt-principles-agents/principles/design/demo-first-design.md"]
---
...
- Treat **Demo First Design** as an explicit decision with defined scope, evidence, owner, and validation.
