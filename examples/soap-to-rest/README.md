...
domain: "soap-to-rest"
source_paths: ["apt-principles-agents/examples/soap-to-rest/README.md"]
---
...
A team needs a reviewable starter pattern for soap to rest without assuming provider-specific behavior.
